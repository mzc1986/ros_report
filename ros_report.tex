...
{\noindent\Huge\bfseries Robotic Engineering 2:\\ ROS-Turtlebot Motion Control and Navigation}\\[2\baselineskip] % Title
{\large \textit{11th May, 2015}}\\[4\baselineskip] % Tagline or further description
{\Large \textsc{ak assad\\ mashruf chowdhury\\yanik porto}} % Author name

\vspace{0.5\textheight} % Whitespace between the title block and the publisher
{\noindent Computer Vision \& Robotics,\\University of Bourgogne, France}\\[\baselineskip] % Publisher and logo
}}
\endgroup}
...
\title{Robotics Engineering 2: ROS-Turtlebot Motion Control and Navigation} \author{ AK Assad \and Mashruf Chowdhury \and Yanik Porto} \date{\today}
\maketitle
